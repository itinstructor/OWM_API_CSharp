...
namespace OpenWeatherMapAPI
{
	public partial class Main
	{
		...
		public double PressureInchesOfMercury { get; }
		...
		public Main(JToken mainData)
		{
			...
			Temperature = new TemperatureObj(
								...
								double.Parse(mainData.SelectToken("feels_like").ToString(), CultureInfo.InvariantCulture));
            ...
            PressureInchesOfMercury = Pressure * 0.02953;
		}
	}
}
